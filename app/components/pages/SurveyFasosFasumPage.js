...
const SurveyFasosFasumPage = ({ onBack }) => {
    ...
    const dropdownOptions = {
        ...
        kategori: ['Fasos', 'Fasum', 'Lainnya'],
        jenisLampu: ['LED', 'Konvensional', 'Solar', 'Lainnya']
    };
    ...
    const handleSubmit = async () => {
        ...
        // Validasi form
        if (!formData.kepemilikanTiang || !formData.kategori || !formData.namaTempat) {
            alert('Mohon isi Kepemilikan Tiang, Kategori, dan Nama Tempat!');
            return;
        }
        ...
        try {
            ...
            const surveyData = {
                ...
                projectTitle: `Survey Fasos Fasum - ${formData.namaTempat}`,
                projectLocation: formData.alamat || formData.titikKordinat,
            ...
            // Upload foto via API route helper: survey-fasos-fasum/{userId}/{docId}/
            ...
            console.log('Survey Fasos Fasum berhasil disimpan dengan ID:', docRef.id);
            ...
            alert('Data Survey Fasos Fasum berhasil disimpan!');
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50">
            ...
            <div className="px-6 py-8 pb-24">
                <div className="max-w-md mx-auto space-y-1">
                    ...
                    {renderDropdownField('kategori', 'Kategori')}
                    {renderInputField('namaTempat', 'Nama Tempat', 'Nama Tempat')}
                    {renderInputField('alamat', 'Alamat', 'Alamat')}
...
export default SurveyFasosFasumPage;
