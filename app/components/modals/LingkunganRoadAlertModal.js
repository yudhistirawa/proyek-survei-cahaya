...
export const LingkunganRoadAlertModal = ({ isOpen, onClose, gridStats, roadStandards }) => {
    ...
    // Evaluasi kriteria jalan lingkungan
                    ...
                    <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-gray-800">Evaluasi Standar Jalan Lingkungan</h2>
                        ...
                        <div className={`mb-6 p-6 rounded-xl border-2 ${getStatusBg(overallStatus)}`}>
                            <div className="flex items-center justify-center gap-3 mb-4">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600 mt-1">Jalan Lingkungan - Lalu Lintas Sangat Rendah</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {overallStatus && (
                            <div className="mb-6 p-5 bg-green-50 border-2 border-green-200 rounded-xl">
                                ...
                                <p className="text-sm text-green-700">
                                    Sistem pencahayaan jalan lingkungan ini telah memenuhi standar yang ditetapkan 
                    ...
                    <div className="sticky bottom-0 bg-gradient-to-r from-gray-50/90 to-white/90 backdrop-blur-xl border-t border-gray-200/50 px-6 py-4 rounded-b-3xl">
                        <div className="flex justify-between items-center">
                            <p className="text-xs text-gray-500 font-medium">
                                Evaluasi berdasarkan standar pencahayaan jalan lingkungan
                            </p>
                            <button 
                                onClick={handleClose}
                                className="px-8 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl hover:from-purple-700 hover:to-violet-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105"
                            >
                                Tutup
                            </button>
                        </div>
