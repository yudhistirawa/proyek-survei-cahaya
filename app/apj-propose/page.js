...
import FormApjPropose from '../components/FormApjPropose';

export default function ApjProposePage() {
  return (
      ...
      <div className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 py-3 md:py-4">
          <div className="flex items-center justify-between gap-2">
            <h1 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 truncate">APJ Propose</h1>
